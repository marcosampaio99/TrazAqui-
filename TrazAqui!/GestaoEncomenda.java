...
public class GestaoEncomenda
{
   ...
   public GestaoEncomenda(HashMap<String,Encomenda> es){
    ...
    // metodo para cliente classificar o servi�o da encomenda entregue por uma empresa com o id fornecido  
    public void classificacaoClienteEmpresa(int id, int p) {
        ((RealizadaEmpresa) (this.encomendas.get(id))).clienteClassifica(p);
    }
    
    // metodo para cliente classificar o servi�o da encomenda entregue por um voluntario com o id fornecido
